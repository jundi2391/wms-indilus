...
import { ScanBarcode, CheckCircle2, Pencil, Trash2, MoreVertical, Search, ArrowDownToLine, Plus, Truck, Eye, Package } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm border-t-4 border-t-[#0C4196] flex flex-col">
              <div className="p-6 flex-1 flex flex-col">
                <h3 className="text-sm font-bold text-slate-900 flex justify-between items-center border-b border-slate-50 pb-4 mb-6 uppercase tracking-wider">
                  <span className="flex items-center gap-2"><ScanBarcode className="w-4 h-4 text-[#0C4196]" /> PDA Scanner</span>
